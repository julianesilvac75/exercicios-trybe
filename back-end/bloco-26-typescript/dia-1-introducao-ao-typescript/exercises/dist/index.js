...
console.log(`Trapézio de base maior 100cm, base menor 70cm e altura 50cm: ${Exercise.trapezium(50, 100, 70)}cm²`);
console.log(`Trapézio de base maior 75cm, base menor 50cm e altura 35cm: ${Exercise.trapezium(35, 75, 50)}cm²`);
console.log(`Trapézio de base maior 150cm, base menor 120cm e altura 80cm: ${Exercise.trapezium(80, 150, 120)}cm²`);
